...
import com.example.blurdialogex.lib.AndroidUtilities;
import com.example.blurdialogex.lib.DispatchQueue;
import com.example.blurdialogex.lib.Theme;
            ...
            for (int i = 0; i < 2; i++) {
                if (blurredBitmapTmp[i] == null || parentView.getMeasuredWidth() != lastW || parentView.getMeasuredHeight() != lastH) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Log.e("BlurBehindDrawable", e.getMessage());
